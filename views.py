...
#This is the first html page the will be appear in the website
...
#To create a new account we need this template
...
#This is the faculty login page
def faculty(request):
...
#After successful login of the faculty they will be redirected to this page
#This page contains the links provided by that paticular faculty only
...
#If they want to delete a paticular file they have to just click on the this delete option    
#Then some process runs to delete that file and returns the refreshed page that contains the required links
def delete(request,filename):
 ...
 #This option enables the faculty to add the drive link of the required pdf or doc
def add(request):
...
#This is forgot password process which will simply sends the otp to the registered e-mail 
#only if the e-mail entered by the user is same as the registered e-mail 
#which is associated with that registration number
...
#If the user successfully logged in then the user redirected to this page
#This page contains the courses offered by the administrator or organization 
...
#This the branch particular page that contains the links of subjects 
#which are in that branch
...
#This the process of getting the password from the database
#and checks weather that password is correct or not
#this function returns the password status i.e.,
#has account  but wrong password,
#has account and correct password,
#no account
...
#This the process of sending the otp from a particular e-mail adderess
#to the user e-mail
#here the password is generated by some functions
#one can use any functions to generate the otp
#note:otp should be unique for all the users and it's not same for the user everytime
...
def sendingotp(mail,name,psawd):
    ...
    subject = "OTP"
    msg['Subject'] = subject
    l=#any function to generate otp
    nl=#any function to generate otp
    pl=#any function to generate otp
...
#For some user information and some processes in this program are depended on the ip adderess
#and also the ip adderess is stored on the database
...
#This are some html page functions that are not used in this program
